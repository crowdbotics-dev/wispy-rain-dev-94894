"""
Django settings for wispy_rain_dev_94894 project.
...
ROOT_URLCONF = 'wispy_rain_dev_94894.urls'
...
WSGI_APPLICATION = 'wispy_rain_dev_94894.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_rain_dev_94894 API",
    "DESCRIPTION": "API documentation for wispy_rain_dev_94894 App",
    "VERSION": "v1",
}
